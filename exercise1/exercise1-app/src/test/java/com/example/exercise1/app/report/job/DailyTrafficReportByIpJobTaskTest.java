...
public class DailyTrafficReportByIpJobTaskTest {
	...
	private void init() throws Exception {
		...
		controller = new TrafficReportController(new TrafficReportByIpService(RequestFactory.buildRepository()));
	...
	public void testJson() throws Exception {
		...
		service.run();
		String actual = String.join(System.lineSeparator(), Files.readAllLines(reportPath));
